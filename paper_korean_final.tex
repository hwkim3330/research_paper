...
\begin{itemize}
    ...
    \item \textbf{평균 개선율}: 92.7% (95% 신뢰구간: [90.2%, 95.2%])
    \item \textbf{변동성 감소}: 지터 표준편차가 15.4ms에서 0.8ms로 94.8% 감소
    \item \textbf{극값 안정성}: 99백분위 지터가 67.8ms에서 4.2ms로 93.8% 개선
\end{itemize}
...
\begin{table}[h]
\centering
\caption{대역폭 공정성 평가 결과}
\label{tab:fairness_analysis}
\begin{tabular}{lrrrr}
\toprule
\textbf{스트림 수} & \textbf{CBS 없음} & \textbf{CBS 적용} & \textbf{이론값} & \textbf{달성율} \\
 & \textbf{Jain Index} & \textbf{Jain Index} & \textbf{Jain Index} & (\%) \\
\midrule
2 & 0.891 & 0.9997 & 1.000 & 99.97 \\
4 & 0.734 & 0.9994 & 1.000 & 99.94 \\
6 & 0.623 & 0.9989 & 1.000 & 99.89 \\
8 & 0.542 & 0.9982 & 1.000 & 99.82 \\
\textbf{평균} & \textbf{0.698} & \textbf{0.9991} & \textbf{1.000} & \textbf{99.91} \\
\bottomrule
\end{tabular}
\end{table}
\end{itemize}
